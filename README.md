# team-27 Platanus Hack 26: CDMX Project
...
- Ignacio Alonso ([@nachoal](https://github.com/nachoal))
...
2. Point your local `origin` at **both** repos, so a single `git push` updates each one:
   ...
   git remote set-url --add --push origin https://github.com/platanus-hack/platanus-hack-26-mx-team-27.git
